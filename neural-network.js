...
class NeuralNetwork{
    ...
    train(inputArray , targetArray){
        ...
        //calculate hidden layers errors (deltas "dot" transpose of weights1)
        let weight1T = Matrix.transpose(this.weights1);
        let hiddenErrors = Matrix.dot(outputDeltas , weight1T);
